...
var FOUNDATION_PAGES = {
  typography:  '/systems/pages/foundation/typography.html',
  colors:      '/systems/pages/foundation/colors.html',
  tokens:      '/systems/pages/foundation/tokens.html',
  spacing:     '/systems/pages/foundation/spacing.html',
  radius:      '/systems/pages/foundation/radius.html',
  gridsystem:  '/systems/pages/foundation/gridsystem.html',
  iconography:   '/systems/pages/foundation/iconography.html',
  accessibility: '/systems/pages/foundation/accessibility.html'
};

var COMPONENT_PAGES = {
  button:          '/systems/pages/components/button.html',
  'dropdown-button': '/systems/pages/components/dropdown-button.html',
  promptinput:     '/systems/pages/components/promptinput.html',
  input:           '/systems/pages/components/input.html',
  select:          '/systems/pages/components/select.html',
  checkbox:        '/systems/pages/components/checkbox.html',
  radio:           '/systems/pages/components/radio.html',
  toggle:          '/systems/pages/components/toggle.html',
  slider:          '/systems/pages/components/slider.html',
  formfield:       '/systems/pages/components/formfield.html',
  badge:           '/systems/pages/components/badge.html',
  alert:           '/systems/pages/components/alert.html',
  toast:           '/systems/pages/components/toast.html',
  tooltip:         '/systems/pages/components/tooltip.html',
  progress:        '/systems/pages/components/progress.html',
  skeleton:        '/systems/pages/components/skeleton.html',
  spinner:         '/systems/pages/components/spinner.html',
  emptystate:      '/systems/pages/components/emptystate.html',
  avatar:          '/systems/pages/components/avatar.html',
  navbar:          '/systems/pages/components/navbar.html',
  'sidebar-menu':  '/systems/pages/components/sidebar.html',
  tabs:            '/systems/pages/components/tabs.html',
  topbarmenu:      '/systems/pages/components/topbarmenu.html',
  breadcrumb:      '/systems/pages/components/breadcrumb.html',
  pagination:      '/systems/pages/components/pagination.html',
  stepper:         '/systems/pages/components/stepper.html',
  card:            '/systems/pages/components/card.html',
  mediacard:       '/systems/pages/components/mediacard.html',
  modal:           '/systems/pages/components/modal.html',
  drawer:          '/systems/pages/components/drawer.html',
  accordion:       '/systems/pages/components/accordion.html',
  popover:         '/systems/pages/components/popover.html',
  table:           '/systems/pages/components/table.html',
  statcard:        '/systems/pages/components/statcard.html',
  datatable:       '/systems/pages/components/datatable.html',
  chart:           '/systems/pages/components/chart.html',
  timeline:        '/systems/pages/components/timeline.html',
  airesponse:      '/systems/pages/components/airesponse.html',
  thinking:        '/systems/pages/components/thinking.html',
  confidence:      '/systems/pages/components/confidence.html',
  citation:        '/systems/pages/components/citation.html',
  suggestion:      '/systems/pages/components/suggestion.html',
  modelselector:   '/systems/pages/components/modelselector.html',
  tokenmeter:      '/systems/pages/components/tokenmeter.html',
  feedback:        '/systems/pages/components/feedback.html',
  diffviewer:      '/systems/pages/components/diffviewer.html',
  prompthistory:   '/systems/pages/components/prompthistory.html',
  aimodetoggle:    '/systems/pages/components/aimodetoggle.html'
};
...
(function() {
  ...
  var NAV_GROUPS = [
    ...
    { group: 'Foundation', icon: 'ti-stack-2', items: [
      { id: 'typography',  label: 'Typography',    href: '/systems/pages/foundation/typography.html' },
      { id: 'colors',      label: 'Color system',  href: '/systems/pages/foundation/colors.html' },
      { id: 'tokens',      label: 'Tokens',        href: '/systems/pages/foundation/tokens.html' },
      { id: 'spacing',     label: 'Spacing',       href: '/systems/pages/foundation/spacing.html' },
      { id: 'radius',      label: 'Border radius', href: '/systems/pages/foundation/radius.html' },
      { id: 'gridsystem',  label: 'Grid system',   href: '/systems/pages/foundation/gridsystem.html' },
      { id: 'iconography',   label: 'Iconography',   href: '/systems/pages/foundation/iconography.html' },
      { id: 'accessibility', label: 'Accessibility', href: '/systems/pages/foundation/accessibility.html' }
    ]},
